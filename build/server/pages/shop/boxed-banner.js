...
function ShopBoxedBanner() {
  return __jsx("main", {
    className: "main"
  }, __jsx(react_helmet__WEBPACK_IMPORTED_MODULE_1__.Helmet, null, __jsx("title", null, "Riode React eCommerce Template - Shop Boxed Banner Page")), __jsx("h1", {
    className: "d-none"
  }, "Riode React eCommerce Template - Shop Boxed Banner Page"), __jsx("nav", {
    className: "breadcrumb-nav"
  }, __jsx("div", {
    className: "container"
  }, __jsx("ul", {
    className: "breadcrumb"
  }, __jsx("li", null, __jsx(_components_features_custom_link__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
    href: "/"
  }, __jsx("i", {
    className: "d-icon-home"
  }))), __jsx("li", null, "Shop")))), __jsx("div", {
    ...
    className: "banner-subtitle font-weight-bold ls-normal text-uppercase text-white"
  }, "Riode Shop"), __jsx("h1", {
    className: "banner-title font-weight-bold text-white"
  }, "Boxed Banner Style"), __jsx(_components_features_custom_link__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z, {
    href: "/shop",
    className: "btn btn-white btn-outline btn-rounded text-normal"
  }, "Discover now", __jsx("i", {
    className: "d-icon-arrow-right"
  })))), __jsx("div", {
    className: "row gutter-lg mt-6"
...
/* harmony default export */ __webpack_exports__["default"] = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().memo(ShopBoxedBanner));
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,5588,5961,4138,6090,5708,6723,4246,2674,2078,4298,5379,5122,1496,1506], function() { return __webpack_exec__(9563); });
