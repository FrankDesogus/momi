...
function PostMasonry({
  ...
  return __jsx("main", {
  ...
  }, __jsx((react_helmet__WEBPACK_IMPORTED_MODULE_3___default()), null, __jsx("title", null, "Riode React eCommerce Template | Blog Masonry ", column)), __jsx("h1", {
    className: "d-none"
  }, "Riode React eCommerce Template - Blog Masonry ", column), __jsx("nav", {
    ...
    href: "/blog/classic",
    className: "active"
  }, "Blog")), __jsx("li", null, "Masonry ", column[0], " Columns")))), __jsx("div", {
    ...
    className: `posts grid row masonry masonry-${column}`,
    ref: ref
    ...
    className: `grid-item ${gridClass[column]}`
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,5588,5961,4138,4943,2078,5780], function() { return __webpack_exec__(9106); });
