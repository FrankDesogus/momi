...
/* harmony import */ var _components_features_post_post_seven__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7333);
...
function PostMaskGrid({
  ...
  return __jsx("main", {
  ...
  }, __jsx((react_helmet__WEBPACK_IMPORTED_MODULE_3___default()), null, __jsx("title", null, "Riode React eCommerce Template | Blog Mask Grid")), __jsx("h1", {
    className: "d-none"
  }, "Riode React eCommerce Template - Blog Mask Grid"), __jsx("nav", {
    ...
    href: "/blog/classic",
    className: "active"
  }, "Blog")), __jsx("li", null, "Mask Grid")))), __jsx("div", {
    ...
    className: "posts grid row grid grid-3cols mb-5"
    ...
    className: "grid-item"
  }, __jsx(_components_features_post_post_seven__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
    post: post,
    adClass: ""
  })))) : __jsx("div", {
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_server_apollo__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)({
  ssr: true
})((0,next_router__WEBPACK_IMPORTED_MODULE_1__.withRouter)(PostMaskGrid)));
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,5588,5961,2078,7333], function() { return __webpack_exec__(1736); });
