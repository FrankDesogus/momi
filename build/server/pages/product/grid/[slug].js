...
;// CONCATENATED MODULE: ./components/partials/product/media/media-two.jsx
...
function MediaTwo(props) {
  ...
  return __jsx((external_react_default()).Fragment, null, __jsx("div", {
    className: "product-gallery row cols-sm-2"
...
;// CONCATENATED MODULE: ./pages/product/grid/[slug].jsx
...
function ProductGrid() {
  ...
  return _slug_jsx("main", {
    className: "main mt-6 single-product product-layout-grid"
  }, _slug_jsx((external_react_helmet_default()), null, _slug_jsx("title", null, "Riode React eCommerce Template | Product Grid")), _slug_jsx("h1", {
    className: "d-none"
  }, "Riode React eCommerce Template - Product Grid"), product !== undefined ? _slug_jsx("div", {
    className: `page-content mb-10 pb-6 ${loaded ? '' : 'd-none'}`
  }, _slug_jsx("div", {
    className: "container skeleton-body"
  }, _slug_jsx("div", {
    className: "product product-single row mb-8"
  }, _slug_jsx("div", {
    className: "col-md-6"
  }, _slug_jsx(MediaTwo, {
    product: product
    ...
    className: "col-md-6 sticky-sidebar-wrapper cols-sm-2"
  }, _slug_jsx("div", {
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,5588,5961,4138,4943,6090,5708,6723,4246,2674,7845,1473,7684,6775,7185,1338,4617], function() { return __webpack_exec__(2889); });
