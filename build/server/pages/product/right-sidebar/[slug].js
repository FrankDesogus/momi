...
/* harmony import */ var _components_partials_product_product_sidebar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(7081);
...
function ProductRightSidebar() {
  ...
  }, __jsx((react_helmet__WEBPACK_IMPORTED_MODULE_3___default()), null, __jsx("title", null, "Riode React eCommerce Template | Product With Right Sidebar")), __jsx("h1", {
    className: "d-none"
  }, "Riode React eCommerce Template - Product With Right Sidebar"), product !== undefined ? __jsx("div", {
    className: `page-content mb-10 pb-6 ${loaded ? '' : 'd-none'}`
  }, __jsx("div", {
    className: "container skeleton-body"
  }, __jsx("div", {
    className: "row mt-6 gutter-lg"
  }, __jsx(_components_partials_product_product_sidebar__WEBPACK_IMPORTED_MODULE_12__/* .default */ .Z, null), __jsx("div", {
    className: "col-lg-9"
  }, __jsx("div", {
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,5588,5961,4138,4943,6090,5708,6723,4246,2674,7845,1473,7684,6775,5379,7185,1338,4617,6295,4422,7081], function() { return __webpack_exec__(2756); });
