...
function PostNine(props) {
  ...
  return __jsx("div", {
    className: `post post-grid ${post.type === 'video' ? 'post-video' : ''} ${adClass}`
  }, post.type === 'image' || post.type === 'video' || type === 'masonry' ? __jsx("figure", {
...
/* harmony default export */ __webpack_exports__["Z"] = (PostNine);
